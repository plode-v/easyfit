const HeroBanner = () => {
    return (
        <div className="flex h-max lg:h-[70vh] flex-col md:flex-row w-full bg-green-500 items-center">
            <div className="flex-1 flex flex-col w-full h-max text-white py-[20px] md:pl-10 pl-2">
